...
class CustomerAddressService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/customer-address/count';
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\CustomerAddressCreate $entity The customer object which should be created. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\CustomerAddress
	 */
	...
	public function createWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/customer-address/create';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\CustomerAddress', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	...
	public function deleteWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/customer-address/delete';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/customer-address/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/customer-address/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	/**
	 * Operation selectDefaultAddress
	 *
	...
	public function selectDefaultAddress($space_id, $id) {
		return $this->selectDefaultAddressWithHttpInfo($space_id, $id)->getData();
	}
	...
	public function selectDefaultAddressWithHttpInfo($space_id, $id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling selectDefaultAddress');
		}
		// verify the required parameter 'id' is set
		if (is_null($id)) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling selectDefaultAddress');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
		...
		// path params
		$resourcePath = '/customer-address/select-default-address';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\CustomerAddressActive $entity The customer object with the properties which should be updated. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\CustomerAddress
	...
	public function updateWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/customer-address/update';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
