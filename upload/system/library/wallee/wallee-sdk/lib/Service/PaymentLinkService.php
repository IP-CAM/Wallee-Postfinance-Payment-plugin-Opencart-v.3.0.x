...
class PaymentLinkService {
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\PaymentLinkCreate $entity The payment link object with the properties which should be created. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\PaymentLink
	 */
	...
	public function createWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/payment-link/create';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Wallee\Sdk\Model\PaymentLink',
				'/payment-link/create'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\PaymentLink', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	...
	public function deleteWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/payment-link/delete';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/payment-link/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\EntityQuery $query The query restricts the payment links which are returned by the search. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\PaymentLink[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/payment-link/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\PaymentLinkUpdate $entity The object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\PaymentLink
	...
	public function updateWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/payment-link/update';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
