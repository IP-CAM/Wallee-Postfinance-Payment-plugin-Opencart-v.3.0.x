...
/**
 * ChargeFlowLevelPaymentLinkService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
...
class ChargeFlowLevelPaymentLinkService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/charge-flow-level-payment-link/count';
	 ...
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\ChargeFlowLevelPaymentLink
	 */
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/charge-flow-level-payment-link/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Wallee\Sdk\Model\ChargeFlowLevelPaymentLink',
				'/charge-flow-level-payment-link/read'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\ChargeFlowLevelPaymentLink', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\EntityQuery $query The query restricts the charge flow level payment links which are returned by the search. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\ChargeFlowLevelPaymentLink[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/charge-flow-level-payment-link/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
