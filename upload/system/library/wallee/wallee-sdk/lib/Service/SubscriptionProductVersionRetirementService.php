...
class SubscriptionProductVersionRetirementService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/subscription-product-version-retirement/count';
	...
	public function createWithHttpInfo($space_id, $retirement) {
		...
		// path params
		$resourcePath = '/subscription-product-version-retirement/create';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/subscription-product-version-retirement/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/subscription-product-version-retirement/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
