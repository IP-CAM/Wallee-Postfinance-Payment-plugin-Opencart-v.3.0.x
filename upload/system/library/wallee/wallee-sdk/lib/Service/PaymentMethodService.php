...
class PaymentMethodService {
	...
	public function allWithHttpInfo() {
		...
		// path params
		$resourcePath = '/payment-method/all';
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Wallee\Sdk\Model\PaymentMethod[]',
				'/payment-method/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\PaymentMethod[]', $response->getHeaders()));
	...
	public function readWithHttpInfo($id) {
		...
		// path params
		$resourcePath = '/payment-method/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
