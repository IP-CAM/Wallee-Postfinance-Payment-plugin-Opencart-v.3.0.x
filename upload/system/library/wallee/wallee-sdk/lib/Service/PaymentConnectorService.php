...
/**
 * PaymentConnectorService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
...
class PaymentConnectorService {
	...
	public function allWithHttpInfo() {
		...
		// path params
		$resourcePath = '/payment-connector/all';
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Wallee\Sdk\Model\PaymentConnector[]',
				'/payment-connector/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\PaymentConnector[]', $response->getHeaders()));
	...
	public function readWithHttpInfo($id) {
		...
		// path params
		$resourcePath = '/payment-connector/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
