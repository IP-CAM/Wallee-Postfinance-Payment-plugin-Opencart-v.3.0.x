...
/**
 * PaymentMethodBrandService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
...
class PaymentMethodBrandService {
	...
	public function allWithHttpInfo() {
		...
		// path params
		$resourcePath = '/payment-method-brand/all';
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Wallee\Sdk\Model\PaymentMethodBrand[]',
				'/payment-method-brand/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\PaymentMethodBrand[]', $response->getHeaders()));
	...
	public function readWithHttpInfo($id) {
		...
		// path params
		$resourcePath = '/payment-method-brand/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
