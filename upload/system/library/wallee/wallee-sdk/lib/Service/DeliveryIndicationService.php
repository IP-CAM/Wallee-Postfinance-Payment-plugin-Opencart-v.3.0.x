...
class DeliveryIndicationService {
	 ...
	 */
	public function markAsNotSuitable($space_id, $delivery_indication_id) {
		return $this->markAsNotSuitableWithHttpInfo($space_id, $delivery_indication_id)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function markAsNotSuitableWithHttpInfo($space_id, $delivery_indication_id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling markAsNotSuitable');
		}
		// verify the required parameter 'delivery_indication_id' is set
		if (is_null($delivery_indication_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $delivery_indication_id when calling markAsNotSuitable');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
		...
		// body params
		$tempBody = null;
		if (isset($delivery_indication_id)) {
			$tempBody = $delivery_indication_id;
		}
	 ...
	 * @return \Wallee\Sdk\Model\DeliveryIndication
	 */
	public function markAsSuitable($space_id, $delivery_indication_id) {
		return $this->markAsSuitableWithHttpInfo($space_id, $delivery_indication_id)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function markAsSuitableWithHttpInfo($space_id, $delivery_indication_id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling markAsSuitable');
		}
		// verify the required parameter 'delivery_indication_id' is set
		if (is_null($delivery_indication_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $delivery_indication_id when calling markAsSuitable');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
