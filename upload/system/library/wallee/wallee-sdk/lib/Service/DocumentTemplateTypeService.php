...
/**
 * DocumentTemplateTypeService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
...
class DocumentTemplateTypeService {
	...
	public function allWithHttpInfo() {
		...
		// path params
		$resourcePath = '/document-template-type/all';
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				'/document-template-type/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\DocumentTemplateType[]', $response->getHeaders()));
	...
	public function readWithHttpInfo($id) {
		...
		// path params
		$resourcePath = '/document-template-type/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
