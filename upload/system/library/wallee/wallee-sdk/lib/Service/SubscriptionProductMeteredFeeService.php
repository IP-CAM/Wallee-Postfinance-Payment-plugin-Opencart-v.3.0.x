...
/**
 * SubscriptionProductMeteredFeeService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
 ...
 */
class SubscriptionProductMeteredFeeService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/count';
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				'int',
				'/subscription-product-metered-fee/count'
			);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\ProductMeteredFeeUpdate $entity The metered fee object with the properties which should be created. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	...
	public function createWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/create';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				'/subscription-product-metered-fee/create'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\ProductMeteredFee', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	...
	public function deleteWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/delete';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				null,
				'/subscription-product-metered-fee/delete'
			);
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				'\Wallee\Sdk\Model\ProductMeteredFee',
				'/subscription-product-metered-fee/read'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\ProductMeteredFee', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\EntityQuery $query The query restricts the metered fees which are returned by the search. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\ProductMeteredFee[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				'\Wallee\Sdk\Model\ProductMeteredFee[]',
				'/subscription-product-metered-fee/search'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\ProductMeteredFee[]', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Wallee\Sdk\Model\ProductMeteredFeeUpdate $entity The metered fee object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @throws \Wallee\Sdk\VersioningException
	 * @throws \Wallee\Sdk\Http\ConnectionException
	 * @return \Wallee\Sdk\Model\ProductMeteredFee
	...
	public function updateWithHttpInfo($space_id, $entity) {
		...
		// path params
		$resourcePath = '/subscription-product-metered-fee/update';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$headerParams,
				'\Wallee\Sdk\Model\ProductMeteredFee',
				'/subscription-product-metered-fee/update'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Wallee\Sdk\Model\ProductMeteredFee', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
