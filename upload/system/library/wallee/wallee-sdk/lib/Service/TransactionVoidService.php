...
/**
 * TransactionVoidService service
 *
 * @category Class
 * @package  Wallee\Sdk
 * @author   wallee AG
...
class TransactionVoidService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/transaction-void/count';
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/transaction-void/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/transaction-void/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 * @return \Wallee\Sdk\Model\TransactionVoid
	 */
	public function voidOffline($space_id, $id) {
		return $this->voidOfflineWithHttpInfo($space_id, $id)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function voidOfflineWithHttpInfo($space_id, $id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling voidOffline');
		}
		// verify the required parameter 'id' is set
		if (is_null($id)) {
		...
		// path params
		$resourcePath = '/transaction-void/voidOffline';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 * @return \Wallee\Sdk\Model\TransactionVoid
	 */
	public function voidOnline($space_id, $id) {
		return $this->voidOnlineWithHttpInfo($space_id, $id)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function voidOnlineWithHttpInfo($space_id, $id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling voidOnline');
		}
		// verify the required parameter 'id' is set
		if (is_null($id)) {
